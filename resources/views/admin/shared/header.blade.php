<header id="header" class="header">
  <div class="top-left">
    <div class="navbar-header">
      <a class="navbar-brand" href="{{route('dashboard')}}"><img src="administration/images/logoutt.png" alt="Logo"></a>
    ...
    <div class="header-menu">
      ...
      <div class="user-area dropdown float-right">
        ...
        <div class="user-menu dropdown-menu">
          <a class="nav-link" href="{{route('adminProfile',Auth::guard('admin')->user()->id)}}"><i class="fa fa- user"></i>Thông tin tài khoản</a>
